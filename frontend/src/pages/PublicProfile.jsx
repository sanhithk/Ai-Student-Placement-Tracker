...
const PublicProfile = () => {
  ...
  if (loading) return <div className="min-h-screen bg-slate-950 flex items-center justify-center text-white text-xl">Loading AI Profile...</div>;
  if (error) return <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center text-red-500 gap-4">
    ...
    <div className="min-h-screen bg-slate-950 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className={`grid gap-6 ${data.jdMatchScore ? 'grid-cols-1 md:grid-cols-2' : 'grid-cols-1'}`}>
          <Card className="bg-gradient-to-br from-slate-900 to-slate-800 border-slate-700 shadow-2xl relative overflow-hidden">
            ...
            <Card className="bg-gradient-to-br from-slate-900 to-slate-800 border-slate-700 shadow-2xl relative overflow-hidden">
              <CardBody className="p-8 flex items-center gap-8 relative z-10">
                <div className="relative w-32 h-32 flex items-center justify-center shrink-0">
                  ...
                  <span className="absolute text-4xl font-black text-white">{data.jdMatchScore}</span>
                </div>
                <div>
                  <h2 className="text-2xl font-bold text-white mb-2">Target Job Match</h2>
                  <p className="text-slate-400 leading-relaxed">
        ...
        <div className="bg-gradient-to-r from-primary-900/40 to-sky-900/40 border border-primary-500/30 rounded-2xl p-8 text-center shadow-2xl shadow-primary-900/20 my-10">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">Can your resume beat {data.user}'s score?</h2>
          <p className="text-slate-300 mb-8 max-w-xl mx-auto">Upload your resume and let our advanced AI instantly analyze, score, and roast your profile for free.</p>
          <Link to="/register">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              <h3 className="text-lg font-semibold text-slate-200">AI Feedback</h3>
            </CardHeader>
            <CardBody>
